...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Action_OnTriggerStay_m945850CE78568BF2E18B42AC7013587CAB71660B (Action_t5CC8A74CB9E4C482C0EAE1BA4C72F17B43EB992C* __this, Collider_t1CC3163924FCD6C4CC2E816373A929C1E3D55E76* ___other0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_0);
		ActionEvent_Invoke_m7010175D16515C761A41CF51C55EB1A055B25723_inline(L_0, L_1, NULL);
		// }
		return;
	}
}
...
IL_002a:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_11 = __this->___platformToTP_7;
		NullCheck(L_11);
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_18 = __this->___characterController_6;
		NullCheck(L_18);
		...
		NullCheck(L_19);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_19, _stringLiteralE1EA9908B2ED4C2AD30EC59F79C19087E33FEFF1, (bool)0, NULL);
		// }
		return;
	}
}
